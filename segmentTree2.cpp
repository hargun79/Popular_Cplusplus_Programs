// To implement segment tree to find range maximum and point update
 
#include <bits/stdc++.h> 
using namespace std; 

// Function to get the middle index of given range. 
int getMid(int s,int e) 
{ 
 return s+(e-s)/2; 
} 

// Recursive function to update the value of a node
...
// Recursive function to find the maximum element in a given range
...
// Function to find the max value in given range 
...
{ 
 ...
 cout<<"Max of values in given range = "<<getMax(st,n,1,3)<<'\n'; 
 updateValue(arr,st,0,n-1,1,8,0); 
 cout<<"Updated max of values in given range = "<<getMax(st,n,1,3)<<'\n'; 
 return 0; 
} 
